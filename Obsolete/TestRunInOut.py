...
tablepath = 'Clip16_ThresholdTest.xlsx'
RowNumber = 3
ColumnNumber = 1
...
for frames in range(1, 6675, 1):
    ...
    center_coordinatesleft = (2054, 2073)
    radius2 = 418
    radius3 = 410
    color1 = (0, 0, 255)
    ...
    sheet.cell(row=RowNumber, column=ColumnNumber, value=('clip16_' + str(frames)))
